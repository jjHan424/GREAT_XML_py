...
def main_iter():
        ...
        site_list_long=[leo]
        obsdir = "/workfs/yjqin/data/leo/"+leoshort+"/obs/"+year+"/"
        poddir = "/workfs/yjqin/data/leo/"+leoshort+"/pod/"+year+"/"
        attdir = "/workfs/yjqin/data/leo/"+leoshort+"/att_great/"+year+"/"
        grmdir = "/workfs/yjqin/data/prod/igs/"
        brddir = "/workfs/yjqin/data/nav/"+year+"/"
        dcbdir = "/workfs/yjqin/data/dcb/"+year+"/"

       

        drag = " DRAG_c:360 "
        customer = "EMP_Sc1:90 EMP_Cc1:90 EMP_Sa1:90 EMP_Ca1:90 EMP_Sr1:90 EMP_Cr1:90"
        atmos = "DTM94"
        workdir = "./"
        ...
        update_leo_geometric("./gnut-ppp.xml",site_list_leo,site_list_long,year,doy,hour,minute,second,seslen,attdir,obsdir,grmdir,dcbdir,list_sat)
        update_leo_geometric("./gnut-ppp2.xml",site_list_leo,site_list_long,year,doy,hour,minute,second,seslen,attdir,obsdir,grmdir,dcbdir,list_sat)
        update_oileo_xml("./gnut-oi_leo.xml",year,doy,hour,minute,second,seslen,site_list_long,drag,customer,atmos,attdir)
        update_leoorbxml("./gnut-orblsqleo.xml",site_list_leo,site_list_long,year,doy,hour,minute,second,seslen,list_sat,obsdir,grmdir,attdir,dcbdir)
